...
export const Home = () => {
    ...
    const title = 'Ibex — Get a 7 in IB. Together.';
        ...
        <div className="v2-home">
            ...
            <nav className="v2-nav">
                <div className="v2-nav-inner">
                    <Link to="/" className="v2-logo">
                        ...
                        <span className="v2-logo-name">Ibex</span>
                    </Link>
            ...
            <footer className="v2-footer">
                <div className="v2-footer-inner">
                    <img src={Logo} alt="" className="v2-logo-img" style={{ height: 26, width: 26, objectFit: 'none', objectPosition: 'left center', opacity: 0.6 }} />
                    <span className="v2-logo-name" style={{ opacity: 0.6, fontSize: '0.95rem' }}>Ibex</span>
                    <div className="v2-footer-links">
                        <a href="#features">Features</a>
                        <Link to="/login">Log In</Link>
                        <Link to="/registration">Sign Up</Link>
                    </div>
                    <div className="v2-footer-copy">© {new Date().getFullYear()} Ibex</div>
                </div>
            </footer>
        </div>
    );
